...
const content = {
  en: {
    ...
    back: 'All treatments',
    primary: 'Start from $239',
    secondary: 'Explore the process',
    proof: ['From $239/mo if prescribed', 'U.S.-licensed providers', 'Private fulfillment when prescribed'],
    ...
    ctaBody: 'Start from $239/mo. Completing intake does not guarantee a prescription — a licensed provider decides.',
  ...
  es: {
    ...
    primary: 'Comenzar desde $239',
    secondary: 'Explorar el proceso',
    proof: ['Desde $239/mes si se receta', 'Proveedores licenciados en EE. UU.', 'Surtido privado cuando se receta'],
    ...
    ctaBody: 'Comience desde $239/mes. Completarla no garantiza una receta — un proveedor con licencia decide.',
