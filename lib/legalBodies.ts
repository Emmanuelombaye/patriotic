...
export const LEGAL_BODIES: Record<string, { updated: string; intro?: string; blocks: LegalBlock[] }> = {
  "privacy": {
    ...
    intro: "This Privacy Policy describes how Efexia MD LLC. d/b/a Efexia® (“Efexia®,” “we,” “our,” or “us”) collects, uses, shares, and protects information when you use our websites, online services, assessments, checkout flows, communications, and related services (collectively, the “Efexia® Services”).",
    blocks: [
      {
        heading: "1. Introduction",
        paragraphs: [
          "Efexia® provides a technology platform that connects users with independent US-licensed providers and licensed pharmacies. Efexia® is not a pharmacy. Prescription treatment, if any, is provided only after review by a US-licensed provider and only if clinically appropriate. Services may not be available in all states.",
          "If you are experiencing a medical emergency, call 911 or seek emergency medical care immediately. The Efexia® Services are not for use in emergencies.",
        ],
      },
      {
        heading: "2. Information We Collect",
        paragraphs: [
          "We collect information directly from you, automatically through your use of the Efexia® website and platform, and from third parties such as service providers, clinical partners, and payment processors. The categories below describe the types of information we may collect.",
        ],
      },
      {
        heading: "3. Information You Provide to Us",
        paragraphs: [
          "We collect information you provide when you create an account, complete an assessment, communicate with providers or support, place an order, or otherwise interact with the Efexia® Services. This may include your name, date of birth, contact details, demographic information, account credentials, shipping address, identification information where required, and the contents of messages you send us.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "We use information to provide and operate the Efexia® Services, facilitate provider review, support pharmacy fulfillment where applicable, process payments, communicate with you, personalize and improve the Services, prevent fraud and abuse, ensure security, and comply with legal and regulatory obligations.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Payment information may be collected and processed by third-party payment processors. Efexia® does not store complete payment card numbers unless expressly stated by the payment processor. We may receive limited information such as billing details, last four digits, card brand, and transaction status.",
        ],
      },
      {
        heading: "11. Online Analytics and Advertising",
        paragraphs: [
          "We may work with analytics and advertising partners to understand how the Efexia® Services are used and to deliver relevant marketing. These partners may use cookies and similar technologies to collect information about your activity over time and across services. Depending on your jurisdiction, you may have the right to opt out of certain advertising and analytics processing.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Depending on your state of residence, you may have the right to request access, correction, deletion, portability, or opt-out rights regarding certain personal information. To submit a request, contact privacy@efexiamd.com",
      ...
      },
      {
        ...
        paragraphs: [
          "California residents may have additional rights under the California Consumer Privacy Act (CCPA), as amended, including the right to know the categories and specific pieces of personal information collected, the right to delete, the right to correct, the right to limit use of sensitive personal information, and the right to opt out of certain sharing or sale as defined under California law. To exercise these rights, contact privacy@efexiamd.com.",
        ],
      },
      {
        heading: "15. Nevada Privacy Rights",
        paragraphs: [
          "Nevada residents may have the right to direct us not to sell certain covered information as defined under Nevada law. To submit a request, contact privacy@efexiamd.com.",
        ],
      },
      {
        heading: "16. Children’s Privacy",
        paragraphs: [
          "The Efexia® Services are intended for adults 18 years of age or older. We do not knowingly collect personal information from children under 13. If you believe a child has provided personal information, contact privacy@efexiamd.com and we will take appropriate action.",
        ],
      },
      {
        heading: "17. How We Protect Information",
        paragraphs: [
          "We use administrative, technical, and physical safeguards designed to protect information. No system is 100% secure, and we cannot guarantee absolute security of information transmitted to or from the Efexia® Services.",
        ],
      },
      {
        heading: "18. Retention of Information",
        paragraphs: [
          "We retain information for as long as necessary to provide the Efexia® Services, comply with legal and regulatory obligations (including medical recordkeeping requirements), resolve disputes, and enforce our agreements.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "For privacy questions or to exercise your rights, contact: privacy@efexiamd.com.",
      ...
      },
      {
        ...
        paragraphs: [
          "Our use of cookies and similar technologies is described in Section 6 above. You may manage your preferences through your browser settings or any cookie preference tools made available within the Efexia® platform.",
        ],
      },
    ],
  },
    ...
    blocks: [
      {
        heading: "1. INTRODUCTION",
        paragraphs: [
          "These Terms of Use govern your access to and use of the websites, online services, assessments, checkout flows, patient-facing technology, communications, and related non-clinical services provided by Efexia MD LLC d/b/a Efexia® (the “Company,” “we,” “our,” or “us”) (collectively, the “Services”). By accessing or using the Services, you agree to these Terms.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Efexia MD LLC",
          "8290 Cedar Grove RD Cross Plains, TN 37049",
          "support@efexiamd.com",
          "(260) 466 8194",
        ],
      },
    ],
  ...
  "medical-consent": {
    updated: "August 17, 2026",
    intro: "The information provided through the Efexia® website, assessments, product pages, checkout flows, communications, and related services is for general informational purposes only and is not a substitute for professional medical advice, diagnosis, or treatment.",
    blocks: [
      {
  ...
  "telehealth-consent": {
    updated: "August 17, 2026",
    intro: "This Telehealth Consent explains how telehealth services may be provided through the Efexia® platform. By using the Efexia® Services, completing an assessment, submitting information, or proceeding with provider review, you consent to receive care through telehealth where permitted by applicable law. Efexia® is not a pharmacy and does not itself practice medicine. Medical services, if available, are provided by independent US-licensed providers or affiliated clinical partners.",
    blocks: [
      {
